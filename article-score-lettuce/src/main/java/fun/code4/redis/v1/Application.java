...
public class Application {
  ...
  private static Map<Long, ArticleV1> getArticleMap() {
    ...
    articleV1Map.put(
        100001L, new ArticleV1("title1", "link1", "100001", now++, 0));
    articleV1Map.put(
        100002L, new ArticleV1("title2", "link2", "100002", now++, 0));
    articleV1Map.put(
        100003L, new ArticleV1("title3", "link3", "100003", now++, 0));
    articleV1Map.put(
        100004L, new ArticleV1("title4", "link4", "100004", now++, 0));
    articleV1Map.put(
        100005L, new ArticleV1("title5", "link5", "100005", now++, 0));
    articleV1Map.put(
        100006L, new ArticleV1("title6", "link6", "100006", now++, 0));
    return articleV1Map;
  }
